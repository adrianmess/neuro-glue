				...
				<button >Delete Set</button>
					...
					<div id="cardList">
						<CardEditorList
							...
							currentCardSetCardsCardDate={this.props.currentCardSetCardsCardDate}
							currentCardSetCardsCardFront={this.props.currentCardSetCardsCardFront}
							currentCardSetCardsCardFack={this.props.currentCardSetCardsCardFack}
							currentCardSetCardsCardFotes={this.props.currentCardSetCardsCardFotes}
						/>
					</div>
					<div id="cardEditor">
						<CardEditor
